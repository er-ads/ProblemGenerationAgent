...
# (ProblemGeneratorV4.py generates 9 Problems with Results)
...
# Load existing successful problems (merge at end)
existing_records = []
...
while current_iteration < max_iterations and len(successful_problems) < target_problems:
    ...
    # select scenario for this iteration (round-robin)
    ...
    for cycle_no in range(2):
        ...
        # helper to format the alternate_scenarios argument: pass single scenario (wrapped in list for compatibility)
        ...
        # If invalid, retry Call2 once with validation feedback
        ...
        # Compute signature & check duplicates against previous_problems
